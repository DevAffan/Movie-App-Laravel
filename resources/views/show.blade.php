    ...
    <div class="movie-info border-b border-gray-800">
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            <div class="flex-none">
                ...
                <img src="{{"https://image.tmdb.org/t/p/w500".$movieDetails['poster_path'] }}" alt="poster" class="w-64 lg:w-96">
                @else
                <img src="https://via.placeholder.com/500x700" alt="poster" class="w-64 lg:w-96">
                @endif
            </div>
            <div class="md:ml-24">
                ...
                <div class="flex flex-wrap items-center text-gray-400 text-sm">
                    ...
                    <span class="ml-1">{{ number_format($movieDetails['vote_average'], 1) }}</span>
                    ...
                    @if ($loop->index < 5)
                        <div class="mt-8">
                            <a href="#">
                                ...
                                <img src="{{'https://image.tmdb.org/t/p/w400'.$cast['profile_path'] }}" alt="actor1" class="hover:opacity-75 transition ease-in-out duration-150">
                                @else
                                <img src="https://via.placeholder.com/400x600" alt="actor1" class="hover:opacity-75 transition ease-in-out duration-150">
                                @endif
                            </a>
                            <div class="mt-2">
