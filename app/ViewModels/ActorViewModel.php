    ...
    public function credits(){
        ...
        return collect($castMovies)->map(function($movie){
            ...
            if(isset($movie['release_date'])) {
                $releasDate = $movie['release_date'];
            } elseif($movie['first_air_date']) {
                $releasDate = $movie['first_air_date'];
            } else {
                $releasDate = '';
            }
            ...
            return collect($movie)->merge([
                ...
                'release_year' => isset($releasDate) ? Carbon::parse($releasDate)->format('Y') : 'Future',
                'title' => $title
            ]);
        });
    }
